...
class TakenDamageParser(HTMLParser):
    ...
    def handle_data(self, data):
        ...
        self.handle_char(data, "Vex'ahlia")
        self.handle_char(data, "Trinket")
        self.handle_char(data, "Vax'ildan")
        ...
        for element in self.characters:    
            if self.column == self.characters[element][0] and self.row > self.characters[element][1] + 3:
                try:
                    nDat = int(data);
                    #print(str(nDat))
                    ...
                    # add individual instances to the instance list
...
#        print("Decl     :", data)
    ...
    def close(self):
        ...
        with open("ParsedDamageDealt/" + self.x + ".csv", "w") as outf:
